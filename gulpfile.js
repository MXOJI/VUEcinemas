...
$.gulp.task('default', $.gulp.series($.gulp.parallel('img','video','html','style','js','fonts','watch','serve')))
$.gulp.task('build', $.gulp.series($.gulp.parallel('img','video','html','style','js','fonts')))